...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback {
    ...
    public void onResourceReady(com.bumptech.glide.load.engine.Resource<?> r7, com.bumptech.glide.load.DataSource r8) {
        /*
            ...
            r0.throwIfRecycled()
            r0 = 0
            java.lang.Object r1 = r6.requestLock     // Catch:{ all -> 0x00c6 }
            monitor-enter(r1)     // Catch:{ all -> 0x00c6 }
            r2 = 0
            r6.loadStatus = r2     // Catch:{ all -> 0x00c3 }
            if (r7 != 0) goto L_0x0037
            com.bumptech.glide.load.engine.GlideException r2 = new com.bumptech.glide.load.engine.GlideException     // Catch:{ all -> 0x00c3 }
            ...
            java.lang.Class<R> r4 = r6.transcodeClass     // Catch:{ all -> 0x00c3 }
            r3.append(r4)     // Catch:{ all -> 0x00c3 }
            ...
            r6.onLoadFailed(r2)     // Catch:{ all -> 0x00c3 }
        ...
        L_0x0036:
            return
        L_0x0037:
            java.lang.Object r3 = r7.get()     // Catch:{ all -> 0x00c3 }
            if (r3 == 0) goto L_0x006c
            java.lang.Class<R> r4 = r6.transcodeClass     // Catch:{ all -> 0x00c3 }
            java.lang.Class r5 = r3.getClass()     // Catch:{ all -> 0x00c3 }
            boolean r4 = r4.isAssignableFrom(r5)     // Catch:{ all -> 0x00c3 }
            if (r4 != 0) goto L_0x004a
            goto L_0x006c
        L_0x004a:
            boolean r4 = r6.canSetResource()     // Catch:{ all -> 0x00c3 }
            if (r4 != 0) goto L_0x0060
            r0 = r7
            r6.resource = r2     // Catch:{ all -> 0x00c3 }
            com.bumptech.glide.request.SingleRequest$Status r2 = com.bumptech.glide.request.SingleRequest.Status.COMPLETE     // Catch:{ all -> 0x00c3 }
            r6.status = r2     // Catch:{ all -> 0x00c3 }
            monitor-exit(r1)     // Catch:{ all -> 0x00c3 }
        ...
        L_0x005f:
            return
        L_0x0060:
            r6.onResourceReady(r7, r3, r8)     // Catch:{ all -> 0x00c3 }
            monitor-exit(r1)     // Catch:{ all -> 0x00c3 }
        ...
        L_0x006c:
            ...
            java.lang.Class<R> r5 = r6.transcodeClass     // Catch:{ all -> 0x00c3 }
            r4.append(r5)     // Catch:{ all -> 0x00c3 }
