...
public class Glide implements ComponentCallbacks2 {
    ...
    Glide(Context context, Engine engine2, MemoryCache memoryCache2, BitmapPool bitmapPool2, ArrayPool arrayPool2, RequestManagerRetriever requestManagerRetriever2, ConnectivityMonitorFactory connectivityMonitorFactory2, int logLevel, RequestOptionsFactory defaultRequestOptionsFactory2, Map<Class<?>, TransitionOptions<?, ?>> defaultTransitionOptions, List<RequestListener<Object>> defaultRequestListeners, boolean isLoggingRequestOriginsEnabled, boolean isImageDecoderEnabledForBitmaps) {
        ...
        if (!isImageDecoderEnabledForBitmaps || Build.VERSION.SDK_INT < 28) {
            ResourceDecoder<InputStream, Bitmap> byteBufferBitmapDecoder2 = new ByteBufferBitmapDecoder(downsampler);
            byteBufferBitmapDecoder = new StreamBitmapDecoder(downsampler, arrayPool3);
            streamBitmapDecoder = byteBufferBitmapDecoder2;
        } else {
            ResourceDecoder<ByteBuffer, Bitmap> streamBitmapDecoder2 = new InputStreamBitmapImageDecoderResourceDecoder();
            byteBufferBitmapDecoder = streamBitmapDecoder2;
            streamBitmapDecoder = new ByteBufferBitmapImageDecoderResourceDecoder();
        }
        ...
        ResourceLoader.StreamFactory resourceLoaderStreamFactory2 = resourceLoaderStreamFactory;
        this.registry.append(ByteBuffer.class, new ByteBufferEncoder()).append(InputStream.class, new StreamEncoder(arrayPool3)).append(Registry.BUCKET_BITMAP, ByteBuffer.class, Bitmap.class, streamBitmapDecoder).append(Registry.BUCKET_BITMAP, InputStream.class, Bitmap.class, byteBufferBitmapDecoder);
        ...
        this.registry.append(Integer.TYPE, InputStream.class, resourceLoaderStreamFactory3).append(Integer.TYPE, ParcelFileDescriptor.class, resourceLoaderFileDescriptorFactory3).append(Integer.class, InputStream.class, resourceLoaderStreamFactory3).append(Integer.class, ParcelFileDescriptor.class, resourceLoaderFileDescriptorFactory3).append(Integer.class, Uri.class, resourceLoaderUriFactory3).append(Integer.TYPE, AssetFileDescriptor.class, resourceLoaderAssetFileDescriptorFactory3).append(Integer.class, AssetFileDescriptor.class, resourceLoaderAssetFileDescriptorFactory3).append(Integer.TYPE, Uri.class, resourceLoaderUriFactory3).append(String.class, InputStream.class, new DataUrlLoader.StreamFactory()).append(Uri.class, InputStream.class, new DataUrlLoader.StreamFactory()).append(String.class, InputStream.class, new StringLoader.StreamFactory()).append(String.class, ParcelFileDescriptor.class, new StringLoader.FileDescriptorFactory()).append(String.class, AssetFileDescriptor.class, new StringLoader.AssetFileDescriptorFactory()).append(Uri.class, InputStream.class, new HttpUriLoader.Factory()).append(Uri.class, InputStream.class, new AssetUriLoader.StreamFactory(context.getAssets())).append(Uri.class, ParcelFileDescriptor.class, new AssetUriLoader.FileDescriptorFactory(context.getAssets())).append(Uri.class, InputStream.class, new MediaStoreImageThumbLoader.Factory(context3)).append(Uri.class, InputStream.class, new MediaStoreVideoThumbLoader.Factory(context3));
        if (Build.VERSION.SDK_INT >= 29) {
            this.registry.append(Uri.class, InputStream.class, new QMediaStoreUriLoader.InputStreamFactory(context3));
            this.registry.append(Uri.class, ParcelFileDescriptor.class, new QMediaStoreUriLoader.FileDescriptorFactory(context3));
        }
        List<ImageHeaderParser> list = imageHeaderParsers;
        ContentResolver contentResolver2 = contentResolver;
        Class<byte[]> cls3 = cls2;
        ResourceDecoder<ByteBuffer, Bitmap> resourceDecoder2 = byteBufferBitmapDecoder;
        ...
        ResourceDecoder<ParcelFileDescriptor, Bitmap> resourceDecoder3 = parcelFileDescriptorVideoDecoder2;
        BitmapBytesTranscoder bitmapBytesTranscoder4 = bitmapBytesTranscoder;
        ResourceDecoder<ParcelFileDescriptor, Bitmap> resourceDecoder4 = resourceDecoder3;
        ...
        ResourceDrawableDecoder resourceDrawableDecoder4 = resourceDrawableDecoder3;
        ResourceLoader.UriFactory uriFactory = resourceLoaderUriFactory3;
        GlideContext glideContext3 = new GlideContext(context, arrayPool2, this.registry, imageViewTargetFactory, defaultRequestOptionsFactory2, defaultTransitionOptions, defaultRequestListeners, engine2, isLoggingRequestOriginsEnabled, logLevel);
