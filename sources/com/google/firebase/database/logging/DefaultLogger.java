...
public class DefaultLogger implements Logger {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$google$firebase$database$logging$Logger$Level = new int[Logger.Level.values().length];

        static {
            try {
                $SwitchMap$com$google$firebase$database$logging$Logger$Level[Logger.Level.ERROR.ordinal()] = 1;
