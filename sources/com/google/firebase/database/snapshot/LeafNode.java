...
public abstract class LeafNode<T extends LeafNode> implements Node {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$google$firebase$database$snapshot$Node$HashVersion = new int[Node.HashVersion.values().length];

        static {
            try {
                $SwitchMap$com$google$firebase$database$snapshot$Node$HashVersion[Node.HashVersion.V1.ordinal()] = 1;
