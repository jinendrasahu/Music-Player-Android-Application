...
public class DatabaseConfig extends Context {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$google$firebase$database$Logger$Level = new int[Logger.Level.values().length];

        static {
            try {
                $SwitchMap$com$google$firebase$database$Logger$Level[Logger.Level.DEBUG.ordinal()] = 1;
