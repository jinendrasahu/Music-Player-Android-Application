...
public class ViewProcessor {
    ...
    static /* synthetic */ class AnonymousClass2 {
        static final /* synthetic */ int[] $SwitchMap$com$google$firebase$database$core$operation$Operation$OperationType = new int[Operation.OperationType.values().length];

        static {
            try {
                $SwitchMap$com$google$firebase$database$core$operation$Operation$OperationType[Operation.OperationType.Overwrite.ordinal()] = 1;
