...
public class ChildEventRegistration extends EventRegistration {
    ...
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$google$firebase$database$core$view$Event$EventType = new int[Event.EventType.values().length];

        static {
            try {
                $SwitchMap$com$google$firebase$database$core$view$Event$EventType[Event.EventType.CHILD_ADDED.ordinal()] = 1;
