...
class zzki<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public List<zzkr> zzb;
    /* access modifiers changed from: private */
    public Map<K, V> zzc;
    private boolean zzd;
    private volatile zzkt zze;
    /* access modifiers changed from: private */
    public Map<K, V> zzf;
    private volatile zzkn zzg;

    static <FieldDescriptorType extends zzib<FieldDescriptorType>> zzki<FieldDescriptorType, Object> zza(int i) {
        return new zzkl(i);
    }
    ...
    public final V put(K k, V v) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzkr remove = this.zzb.remove(i2 - 1);
            zzg().put((Comparable) remove.getKey(), remove.getValue());
        }
        this.zzb.add(i, new zzkr(this, k, v));
        return null;
    }
    ...
    public final V zzc(int i) {
        ...
        if (!this.zzc.isEmpty()) {
            ...
            this.zzb.add(new zzkr(this, (Map.Entry) it.next()));
            it.remove();
        }
        return value;
    }
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        if (this.zze == null) {
            this.zze = new zzkt(this, (zzkl) null);
        }
        return this.zze;
    }
    ...
    public final Set<Map.Entry<K, V>> zze() {
        if (this.zzg == null) {
            this.zzg = new zzkn(this, (zzkl) null);
        }
        return this.zzg;
    }
    ...
    /* synthetic */ zzki(int i, zzkl zzkl) {
        this(i);
    }
}
