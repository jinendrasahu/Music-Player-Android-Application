...
public class RoundedVignetteBitmapDisplayer extends RoundedBitmapDisplayer {
    ...
    protected static class RoundedVignetteDrawable extends RoundedBitmapDisplayer.RoundedDrawable {
        ...
        public void onBoundsChange(Rect bounds) {
            ...
            RadialGradient vignette = new RadialGradient(this.mRect.centerX(), (this.mRect.centerY() * 1.0f) / 0.7f, 1.3f * this.mRect.centerX(), new int[]{0, 0, 2130706432}, new float[]{0.0f, 0.7f, 1.0f}, Shader.TileMode.CLAMP);
