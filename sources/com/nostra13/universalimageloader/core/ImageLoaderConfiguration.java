...
public final class ImageLoaderConfiguration {
    ...
    /* synthetic */ ImageLoaderConfiguration(Builder x0, AnonymousClass1 x1) {
        this(x0);
    }
    ...
    private static class NetworkDeniedImageDownloader implements ImageDownloader {
        ...
        public InputStream getStream(String imageUri, Object extra) throws IOException {
            int i = AnonymousClass1.$SwitchMap$com$nostra13$universalimageloader$core$download$ImageDownloader$Scheme[ImageDownloader.Scheme.ofUri(imageUri).ordinal()];
            if (i != 1 && i != 2) {
