...
public final class URandomKt {
    ...
    public static final int m876nextUIntqCasIEU(Random $this$nextUInt, int until) {
        Intrinsics.checkParameterIsNotNull($this$nextUInt, "$this$nextUInt");
        return m875nextUInta8DCA5k($this$nextUInt, 0, until);
    }

    /* renamed from: nextUInt-a8DCA5k  reason: not valid java name */
    public static final int m875nextUInta8DCA5k(Random $this$nextUInt, int from, int until) {
        Intrinsics.checkParameterIsNotNull($this$nextUInt, "$this$nextUInt");
    ...
    public static final long m877nextULongV1Xi4fY(Random $this$nextULong, long until) {
        Intrinsics.checkParameterIsNotNull($this$nextULong, "$this$nextULong");
        return m878nextULongjmpaWc($this$nextULong, 0, until);
    }

    /* renamed from: nextULong-jmpaW-c  reason: not valid java name */
    public static final long m878nextULongjmpaWc(Random $this$nextULong, long from, long until) {
        Intrinsics.checkParameterIsNotNull($this$nextULong, "$this$nextULong");
    ...
    public static final long nextULong(Random $this$nextULong, ULongRange range) {
        ...
        if (range.isEmpty()) {
            ...
            return m878nextULongjmpaWc($this$nextULong, range.getFirst(), ULong.m157constructorimpl(range.getLast() + ULong.m157constructorimpl(((long) 1) & 4294967295L)));
        } else {
            if (UnsignedKt.ulongCompare(range.getFirst(), 0) <= 0) {
                return nextULong($this$nextULong);
            }
            long j = ((long) 1) & 4294967295L;
            return ULong.m157constructorimpl(m878nextULongjmpaWc($this$nextULong, ULong.m157constructorimpl(range.getFirst() - ULong.m157constructorimpl(j)), range.getLast()) + ULong.m157constructorimpl(j));
        }
    }

    /* renamed from: nextUBytes-EVgfTAA  reason: not valid java name */
    public static final byte[] m872nextUBytesEVgfTAA(Random $this$nextUBytes, byte[] array) {
    ...
    public static final byte[] m873nextUBytesWvrt4B4(Random $this$nextUBytes, byte[] array, int fromIndex, int toIndex) {
        Intrinsics.checkParameterIsNotNull($this$nextUBytes, "$this$nextUBytes");
        Intrinsics.checkParameterIsNotNull(array, "array");
