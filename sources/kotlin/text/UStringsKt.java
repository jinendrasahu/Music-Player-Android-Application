...
public final class UStringsKt {
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        while (i2 < length) {
            ...
            long limit3 = limit2;
            long limitBeforeMul2 = limitBeforeMul;
            if (UnsignedKt.ulongCompare(result, limitBeforeMul2) <= 0) {
                limit = limit3;
                limitBeforeMul = limitBeforeMul2;
            } else if (limitBeforeMul2 != 512409557603043100L) {
                return null;
            } else {
                limit = limit3;
                long limitBeforeMul3 = UnsignedKt.m316ulongDivideeb3DHEI(limit, uradix);
                if (UnsignedKt.ulongCompare(result, limitBeforeMul3) > 0) {
                    return null;
                }
                limitBeforeMul = limitBeforeMul3;
            }
