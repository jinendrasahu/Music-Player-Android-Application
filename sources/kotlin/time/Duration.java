...
public final class Duration implements Comparable<Duration> {
    ...
    public static final <T> T m959toComponentsimpl(double $this, Function5<? super Integer, ? super Integer, ? super Integer, ? super Integer, ? super Integer, ? extends T> action) {
    ...
    /* renamed from: toComponents-impl  reason: not valid java name */
    public static final <T> T m958toComponentsimpl(double $this, Function4<? super Integer, ? super Integer, ? super Integer, ? super Integer, ? extends T> action) {
        Intrinsics.checkParameterIsNotNull(action, "action");
    ...
    /* renamed from: toComponents-impl  reason: not valid java name */
    public static final <T> T m957toComponentsimpl(double $this, Function3<? super Integer, ? super Integer, ? super Integer, ? extends T> action) {
        Intrinsics.checkParameterIsNotNull(action, "action");
    ...
    /* renamed from: toComponents-impl  reason: not valid java name */
    public static final <T> T m956toComponentsimpl(double $this, Function2<? super Long, ? super Integer, ? extends T> action) {
        Intrinsics.checkParameterIsNotNull(action, "action");
    ...
    public static final double m960toDoubleimpl(double $this, TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return DurationUnitKt.convertDurationUnit($this, DurationKt.getStorageUnit(), unit);
    }

    /* renamed from: toLong-impl  reason: not valid java name */
    public static final long m963toLongimpl(double $this, TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return (long) m960toDoubleimpl($this, unit);
    }

    /* renamed from: toInt-impl  reason: not valid java name */
    public static final int m961toIntimpl(double $this, TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
    ...
    public static String m966toStringimpl(double $this) {
        ...
        if (scientific) {
            ...
            str = FormatToDecimalsKt.formatToExactDecimals(value2, m953precisionimpl($this, Math.abs(value2)));
        }
        sb.append(str);
    ...
    /* renamed from: toString-impl  reason: not valid java name */
    public static final String m967toStringimpl(double $this, TimeUnit unit, int decimals) {
        String str;
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        if (!(decimals >= 0)) {
    ...
    public static final String m962toIsoStringimpl(double $this) {
        ...
        int minutes = m943getMinutesComponentimpl($this$iv);
        int seconds = m945getSecondsComponentimpl($this$iv);
        int nanoseconds = m944getNanosecondsComponentimpl($this$iv);
