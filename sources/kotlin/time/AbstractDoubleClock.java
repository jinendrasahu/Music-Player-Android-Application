...
public abstract class AbstractDoubleClock implements Clock {
    ...
    private static final class DoubleClockMark extends ClockMark {
        ...
        public ClockMark m921plusLRDsOJo(double duration) {
            return new DoubleClockMark(this.startedAt, this.clock, Duration.m952plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }
    }
