    ...
    public final int updateStatusGuard(WindowInsetsCompat insets, Rect rectInsets) {
        ...
        if (actionBarContextView == null) {
            ...
            if (this.mActionModeView.isShown()) {
                ...
                ViewUtils.computeFitSystemWindows(this.mSubDecor, innerInsets, rect2);
                ...
                int systemWindowInsetTop5 = systemWindowInsetTop4;
                if (mlp.topMargin != 0) {
                    mlpChanged = true;
                    i = 0;
                    mlp.topMargin = 0;
                    systemWindowInsetTop2 = systemWindowInsetTop5;
                } else {
                    i = 0;
                    systemWindowInsetTop2 = systemWindowInsetTop5;
                }
