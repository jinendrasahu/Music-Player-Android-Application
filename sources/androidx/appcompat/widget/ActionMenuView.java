...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    private void onMeasureExactFormat(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        } else if (cellsRemaining < visibleItemCount - 1 || singleItem != 0 || maxCellsUsed > 1) {
        ...
        if (needsExpansion) {
            for (int i14 = 0; i14 < childCount; i14++) {
                ...
                if (lp5.expanded) {
                    child5.measure(View.MeasureSpec.makeMeasureSpec((lp5.cellsUsed * cellSize) + lp5.extraPixels, BasicMeasure.EXACTLY), itemHeightSpec);
                }
            }
        }
