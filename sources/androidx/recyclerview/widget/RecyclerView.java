...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public boolean scrollByInternal(int x, int y, MotionEvent ev) {
        ...
        if (this.mAdapter != null) {
            ...
            int consumedY2 = iArr2[1];
            unconsumedX = i - consumedX2;
            unconsumedY = i2 - consumedY2;
        ...
        int unconsumedX2 = unconsumedX - iArr4[0];
        int unconsumedY2 = unconsumedY - iArr4[1];
        boolean consumedNestedScroll = (iArr4[0] == 0 && iArr4[1] == 0) ? false : true;
        int i3 = this.mLastTouchX;
        int[] iArr5 = this.mScrollOffset;
        this.mLastTouchX = i3 - iArr5[0];
        ...
        int consumedX4 = consumedX3;
        if (!(consumedX4 == 0 && consumedY == 0)) {
            dispatchOnScrolled(consumedX4, consumedY);
        }
        if (!awakenScrollBars()) {
            invalidate();
        }
        if (!consumedNestedScroll && consumedX4 == 0 && consumedY == 0) {
            return false;
        }
        return true;
    }
