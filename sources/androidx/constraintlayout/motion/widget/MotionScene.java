...
public class MotionScene {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:51:0x00fa, code lost:
        if (r12.mCurrentTransition != null) goto L_0x011b;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:53:0x0100, code lost:
        if (androidx.constraintlayout.motion.widget.MotionScene.Transition.access$1200(r4) != false) goto L_0x011b;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:57:0x010e, code lost:
        if (androidx.constraintlayout.motion.widget.MotionScene.Transition.access$200(r12.mCurrentTransition) == null) goto L_0x011b;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:60:0x011f, code lost:
        if (androidx.constraintlayout.motion.widget.MotionScene.Transition.access$1200(r4) == false) goto L_0x014d;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:62:0x0125, code lost:
        if (androidx.constraintlayout.motion.widget.MotionScene.Transition.access$000(r4) != -1) goto L_0x012a;
     */
    ...
    private void load(android.content.Context r13, int r14) {
        /*
            ...
            r3 = 0
            r4 = 0
            int r5 = r1.getEventType()     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
        L_0x000f:
            r6 = 1
        ...
        L_0x001c:
            ...
            goto L_0x0154
        L_0x001f:
            java.lang.String r9 = r1.getName()     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r3 = r9
            boolean r9 = r12.DEBUG_DESKTOP     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            if (r9 == 0) goto L_0x003e
            java.io.PrintStream r9 = java.lang.System.out     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            java.lang.StringBuilder r10 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r10.<init>()     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            java.lang.String r11 = "parsing = "
            r10.append(r11)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r10.append(r3)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            java.lang.String r10 = r10.toString()     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r9.println(r10)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
        L_0x003e:
            int r9 = r3.hashCode()     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r10 = -1
        ...
        L_0x0049:
            ...
            boolean r6 = r3.equals(r6)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            if (r6 == 0) goto L_0x0048
            r6 = 4
            goto L_0x008d
        L_0x0053:
            boolean r6 = r3.equals(r11)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            if (r6 == 0) goto L_0x0048
            r6 = 0
            goto L_0x008d
        L_0x005b:
        ...
        L_0x006f:
            ...
            boolean r7 = r3.equals(r7)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
        ...
        L_0x008d:
            switch(r6) {
                ...
                case 6: goto L_0x0092;
                default: goto L_0x0090;
            }     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
        L_0x0090:
            goto L_0x0139
        L_0x0092:
            androidx.constraintlayout.motion.widget.KeyFrames r6 = new androidx.constraintlayout.motion.widget.KeyFrames     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r6.<init>(r13, r1)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            java.util.ArrayList r7 = r4.mKeyFramesList     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r7.add(r6)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            goto L_0x014d
        L_0x00a0:
            r12.parseConstraintSet(r13, r1)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            goto L_0x014d
        L_0x00a5:
            androidx.constraintlayout.widget.StateSet r6 = new androidx.constraintlayout.widget.StateSet     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r6.<init>(r13, r1)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r12.mStateSet = r6     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            goto L_0x014d
        L_0x00ae:
            r4.addOnClick(r13, r1)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            goto L_0x014d
        L_0x00b3:
            if (r4 != 0) goto L_0x00e2
            android.content.res.Resources r6 = r13.getResources()     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            java.lang.String r6 = r6.getResourceEntryName(r14)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            int r7 = r1.getLineNumber()     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r8.<init>()     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            java.lang.String r9 = " OnSwipe ("
            r8.append(r9)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r8.append(r6)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            java.lang.String r9 = ".xml:"
            r8.append(r9)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r8.append(r7)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            java.lang.String r9 = ")"
            r8.append(r9)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            java.lang.String r8 = r8.toString()     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            android.util.Log.v(r11, r8)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
        L_0x00e2:
            androidx.constraintlayout.motion.widget.TouchResponse r6 = new androidx.constraintlayout.motion.widget.TouchResponse     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            androidx.constraintlayout.motion.widget.MotionLayout r7 = r12.mMotionLayout     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r6.<init>(r13, r7, r1)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            androidx.constraintlayout.motion.widget.TouchResponse unused = r4.mTouchResponse = r6     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            goto L_0x014d
        L_0x00ed:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r6 = r12.mTransitionList     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            androidx.constraintlayout.motion.widget.MotionScene$Transition r7 = new androidx.constraintlayout.motion.widget.MotionScene$Transition     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r7.<init>(r12, r13, r1)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r4 = r7
            r6.add(r7)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            androidx.constraintlayout.motion.widget.MotionScene$Transition r6 = r12.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            if (r6 != 0) goto L_0x011b
            boolean r6 = r4.mIsAbstract     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            if (r6 != 0) goto L_0x011b
            r12.mCurrentTransition = r4     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            androidx.constraintlayout.motion.widget.MotionScene$Transition r6 = r12.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            if (r6 == 0) goto L_0x011b
            androidx.constraintlayout.motion.widget.MotionScene$Transition r6 = r12.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            androidx.constraintlayout.motion.widget.TouchResponse r6 = r6.mTouchResponse     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            if (r6 == 0) goto L_0x011b
            androidx.constraintlayout.motion.widget.MotionScene$Transition r6 = r12.mCurrentTransition     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            androidx.constraintlayout.motion.widget.TouchResponse r6 = r6.mTouchResponse     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            boolean r7 = r12.mRtl     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r6.setRTL(r7)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
        L_0x011b:
            boolean r6 = r4.mIsAbstract     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            if (r6 == 0) goto L_0x014d
            int r6 = r4.mConstraintSetEnd     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            if (r6 != r10) goto L_0x012a
            r12.mDefaultTransition = r4     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            goto L_0x012f
        L_0x012a:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r6 = r12.mAbstractTransitionList     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r6.add(r4)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
        L_0x012f:
            java.util.ArrayList<androidx.constraintlayout.motion.widget.MotionScene$Transition> r6 = r12.mTransitionList     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r6.remove(r4)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            goto L_0x014d
        L_0x0135:
            r12.parseMotionSceneTags(r13, r1)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            goto L_0x014d
        L_0x0139:
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r6.<init>()     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            java.lang.String r7 = "WARNING UNKNOWN ATTRIBUTE "
            r6.append(r7)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r6.append(r3)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            java.lang.String r6 = r6.toString()     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            android.util.Log.v(r11, r6)     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
        L_0x014d:
            goto L_0x0154
        L_0x014e:
            java.lang.String r6 = r1.getName()     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r2 = r6
        L_0x0154:
            int r6 = r1.next()     // Catch:{ XmlPullParserException -> 0x0161, IOException -> 0x015c }
            r5 = r6
            goto L_0x000f
        L_0x015b:
            goto L_0x0165
