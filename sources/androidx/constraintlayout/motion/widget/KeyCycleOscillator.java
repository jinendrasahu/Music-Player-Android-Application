...
public abstract class KeyCycleOscillator {
    ...
    public void setup(float pathLength) {
        ...
        if (count != 0) {
            ...
            double[][] values = (double[][]) Array.newInstance(double.class, new int[]{count, 2});
    ...
    static class CycleOscillator {
        ...
        public void setup(float pathLength) {
            ...
            double[][] splineValues = (double[][]) Array.newInstance(double.class, new int[]{this.mPosition.length, 2});
