...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void initPath(KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        this.x = (float) ((int) ((motionPaths3.x + (pathVectorX * path)) - ((scaleX * scaleWidth) / 2.0f)));
        this.y = (float) ((int) ((motionPaths3.y + (pathVectorY * path)) - ((scaleY * scaleHeight) / 2.0f)));
    ...
    public void setView(View view, int[] toUse, double[] data, double[] slope, double[] cycle) {
        ...
        float v_height2 = delta_path;
        if (Float.isNaN(path_rotate) == 0) {
            ...
            float f4 = dv_width;
            float f5 = dv_height;
            float f6 = delta_path2;
            view2.setRotation((float) (((double) rot) + ((double) path_rotate) + Math.toDegrees(Math.atan2((double) ((dv_height / 2.0f) + dv_y), (double) ((dv_width / 2.0f) + dv_x)))));
            ...
            float f9 = dv_width;
            float f10 = dv_height;
            float f11 = delta_path2;
        } else {
            float f12 = dv_x;
            float f13 = dv_y;
            float f14 = dv_width;
            float f15 = dv_height;
            float f16 = delta_path2;
        }
        int l = (int) (v_x + 0.5f);
        int t = (int) (v_y2 + 0.5f);
    ...
    public void getRect(int[] toUse, double[] data, float[] path, int offset) {
        ...
        if (0.0f != 0.0f) {
            ...
            float f8 = x1;
            float f9 = y1;
            float tx1 = xRotate(sin, cos, f6, f7, f8, f9);
            float ty1 = yRotate(sin, cos, f6, f7, f8, f9);
            float f10 = x2;
            float f11 = y2;
            float tx2 = xRotate(sin, cos, f6, f7, f10, f11);
            float ty2 = yRotate(sin, cos, f6, f7, f10, f11);
            float f12 = x3;
            float f13 = y3;
            float tx3 = xRotate(sin, cos, f6, f7, f12, f13);
            float ty3 = yRotate(sin, cos, f6, f7, f12, f13);
            float f14 = x4;
            float f15 = y4;
            x1 = tx1;
            y1 = ty1;
            ...
            x3 = tx3;
            y3 = ty3;
            x4 = xRotate(sin, cos, f6, f7, f14, f15);
            y4 = yRotate(sin, cos, f6, f7, f14, f15);
        } else {
            float f16 = v_y2;
            float f17 = v_width2;
        }
