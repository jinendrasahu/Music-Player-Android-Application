...
public class StateSet {
    ...
    private void load(android.content.Context r14, org.xmlpull.v1.XmlPullParser r15) {
        ...
        L_0x0024:
            ...
            r4 = 0
            r5 = 0
            int r6 = r15.getEventType()     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
        L_0x002b:
            r7 = 1
            ...
            goto L_0x00be
        L_0x003a:
            java.lang.String r7 = r15.getName()     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
            boolean r7 = r8.equals(r7)     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
        ...
        L_0x0045:
            ...
            goto L_0x00be
        L_0x0048:
            java.lang.String r11 = r15.getName()     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
            r3 = r11
            r11 = -1
            int r12 = r3.hashCode()     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
            switch(r12) {
            ...
            }     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
        L_0x0055:
            goto L_0x007c
        L_0x0056:
            java.lang.String r8 = "Variant"
            boolean r8 = r3.equals(r8)     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
        ...
        L_0x007d:
            ...
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
            r8.<init>()     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
            java.lang.String r9 = "unknown tag "
            r8.append(r9)     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
            r8.append(r3)     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
            java.lang.String r8 = r8.toString()     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
            android.util.Log.v(r7, r8)     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
            goto L_0x00b7
        L_0x009c:
            androidx.constraintlayout.widget.StateSet$Variant r7 = new androidx.constraintlayout.widget.StateSet$Variant     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
            r7.<init>(r14, r15)     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
            if (r5 == 0) goto L_0x00b7
            r5.add(r7)     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
            goto L_0x00b7
        L_0x00a7:
            androidx.constraintlayout.widget.StateSet$State r7 = new androidx.constraintlayout.widget.StateSet$State     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
            r7.<init>(r14, r15)     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
            r5 = r7
            android.util.SparseArray<androidx.constraintlayout.widget.StateSet$State> r7 = r13.mStateList     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
            int r8 = r5.mId     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
            r7.put(r8, r5)     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
            goto L_0x00b7
        L_0x00b5:
            goto L_0x00b7
        L_0x00b6:
        ...
        L_0x00b8:
            ...
            r4 = r7
        L_0x00be:
            int r7 = r15.next()     // Catch:{ XmlPullParserException -> 0x00cb, IOException -> 0x00c6 }
            r6 = r7
            goto L_0x002b
        L_0x00c5:
            goto L_0x00cf
