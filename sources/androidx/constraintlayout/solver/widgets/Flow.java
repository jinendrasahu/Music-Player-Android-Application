    ...
    private void measureChainWrap(ConstraintWidget[] widgets, int count, int orientation, int max, int[] measured) {
        ...
        if (i3 != 0) {
            ...
            while (i10 < listCount) {
                ...
                if (orientation == 0) {
                    if (i10 < listCount - 1) {
                        bottom2 = this.mChainList.get(i10 + 1).biggest.mTop;
                        paddingBottom2 = 0;
                    } else {
                        bottom2 = this.mBottom;
                        paddingBottom2 = getPaddingBottom();
                    }
                    current2.setup(orientation, left3, top2, right2, bottom2, paddingLeft2, paddingTop2, paddingRight2, paddingBottom2, max);
                    top2 = current2.biggest.mBottom;
                    paddingTop2 = 0;
                    ...
                    if (i10 < listCount - 1) {
                        right2 = this.mChainList.get(i10 + 1).biggest.mLeft;
                        paddingRight2 = 0;
                    } else {
                        right2 = this.mRight;
